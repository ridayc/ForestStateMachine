...
public class ForestFunctions {
	...
	public static double weightTrees(RandomForest rf, final double[][] tset, final double[] labels, double[] initial_weights){
		// we're given:
	...
	public static double weightTrees3(RandomForest rf, final double[][] tset, final double[] labels){
		// we're given:
		// rf: the (likely) unweighted Random Forest
		// tset: an independent traingset/test set to evaluate the trees
		// labels: true labels for the current set of points
